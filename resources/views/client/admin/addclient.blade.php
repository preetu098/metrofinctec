          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown me-1">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="images1/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
      ...
      <script>
        function adduser()
        {
            Swal.fire({
                ...
                html:`<html>
                    <form>
                        <input type="text" name="code" placeholder="enter employe Code" class="swal2-input"/>
                        <input type="password" name="password" placeholder="enter password" class="swal2-input"/>    
                        <input type="text" name="code" placeholder="enter employe Code" class="swal2-input"/>
                        <input type="password" name="password" placeholder="enter password" class="swal2-input"/>   
                        <input type="text" name="code" placeholder="enter employe Code" class="swal2-input"/>
                        <input type="password" name="password" placeholder="enter password" class="swal2-input"/>   
        ...
        <div class="content-wrapper">
         <div class="card">
            <div class="row mt-3">
               ...
               <div class="col-md-4">
                <button class="btn btn-info" onclick="adduser()">Add Employee</button>
               </div>
               <div class="col-md-4"></div>
            </div>
            <div class="row">
                    ...
                    <div class="responsive-table">
                        <table class="table" style="overflow: auto;">
                             ...
                             <tr>
                                ...
                                <td>Pratibha </td>
                                <td>WDWEDWEDWE</td>
                                <td>Pratibha Rajawat</td>
                                <td>preetu098@gmail.com</td>
                                <td><button class="btn btn-info" onclick="show()">View</button></td>
                             </tr>   
                        </table>
                    </div>
                </div>
