...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 mt-5">
                ...
                <img
                    src="https://i0.wp.com/bemyeye.com/wp-content/uploads/2020/02/Go-in-the-right-direction2.png?fit=768%2C882&ssl=1" />
                            ...
                            <header _ngcontent-gsv-c11="" class="ng-tns-c11-0">
                                <div _ngcontent-gsv-c11="" class="row mr-0 ml-0">
                                    <div _ngcontent-gsv-c11="" class="col-md-12 fi-logo-div">
                                        <div _ngcontent-gsv-c11="" class="d-inline-block"><img _ngcontent-gsv-c11=""
                                                class="fi-logo" src="" style="width:200px"></div>
                                        <div _ngcontent-gsv-c11=""
                                            class="logout-menu d-inline-flex align-items-center float-right"><span
                                                _ngcontent-gsv-c11="" class="cursor">
                                                <!--bindings={
  ...
  "ng-reflect-ng-if": "false"
                                        ...
                                        <div _ngcontent-gsv-c11="" class="d-none"><input _ngcontent-gsv-c11=""
  ...
  "ng-reflect-ng-if": "false"
                ...
                <div class="qsignin-form">
                    ...
                    <h4 style="color:black">Enter your Personal Details</h4>
                     <form autocomplete="off" method="post" action="{{ route('verify_register') }}" novalidate=""
                        class="ng-invalid ng-dirty ng-touched" siq_id="autopick_5958"> 
                        @csrf
                        ...
                        <div class="form-group "><label for="pwd">Annual Income</label>
                            ...
                            <input class="form-control"type="number" id="annual_income" name="annual_income" required=""
                        ...
                        <div class="form-group "><label for="pwd">Country Of Birth</label>
                            ...
                            <input class="form-control"type="text" id="country_of_birth" name="country_of_birth" required=""
                        ...
                        <div class="form-group "><label for="pwd">PinCode</label>
                            ...
                            <input class="form-control" type="number" id="pincode" name="pin_code" required=""
                                placeholder="enter pincode">
                        </div>
                        <div class="signin-mobile-button text-center"><button class="btn btn-primary btn-qsignin"
                                type="submit" style="width:100%">Process</button></div>
                    </form>
                </div>
            </div>
        </div>
