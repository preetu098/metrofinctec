...
<div class="container-fluid">
   <div class="row">
         ...
         <div class="card card-block card-stretch card-height">
            <div class="card-header card-header-border d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Client Remainder</h4>
               </div>
            </div>
            <div class="card-body-list">               
               <ul class="list-style-3 mb-0">
                  ...
                  <li class="p-3 list-item d-flex justify-content-start align-items-center">
                     <div class="avatar">
                        <img class="avatar avatar-img avatar-60 rounded" src="{{ asset('assets2/images/products/4.jpg')}}" alt="4.jpg">                        
                     </div>
                     ...
                     <div class="list-style-action d-flex justify-content-end ml-auto">                        
                        <h6 class="font-weight-bold">Dell</h6>                        
                     </div>
                  </li>
               ...
               <div class="card bg-primary">
                   <div class="card-body">
                       <div class="d-flex align-items-center">
                           ...
                           <div class="ml-3">
                               <h5 class="text-white font-weight-bold">Message Ration <small> </small></h5>
      ...
      <div class="col-lg-4 col-md-6">
         <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Upcoming Stocks</h4>
               </div>
                     ...
                     <tbody>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{ asset('assets2/images/user/2.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{ asset('assets2/images/user/5.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{ asset('assets2/images/user/1.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                                 <div>Max Lynn</div>
                              </div>
                        ...
                        <tr class="white-space-no-wrap">
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="avatar-45 mr-2">
                                    <img src="{{ asset('assets2/images/user/3.jpg')}}" class="img-fluid rounded-circle"
                                       alt="image">
                                 </div>
                                 <div>Danniw Yatt</div>
                              </div>
      ...
      <div class="col-lg-4 col-md-12">
         <div class="card">
            <div class="card-body">
               <h4 class="font-weight-bold mb-3">Message 1</h4>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda harum ipsam incidunt debitis nisi ratione corporis consectetur, fugit porro error!</p>
            </div>
         </div>
      </div>
   </div>
